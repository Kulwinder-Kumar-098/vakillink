...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "http://localhost:5174", "http://127.0.0.1:5173", "http://127.0.0.1:5174"], # React frontend ports
...
try:
    ...
    print("Failed to import Profile router:", e)
...
try:
    from app.api.routers import archive
